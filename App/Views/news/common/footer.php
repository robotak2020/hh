...
<script src="<?php echo assets('exam/lib/easing/easing.min.js'); ?>"></script>
<script src="<?php echo assets('exam/lib/owlcarousel/owl.carousel.min.js'); ?>"></script>
<script src="<?php echo assets('exam/lib/isotope/isotope.pkgd.min.js'); ?>"></script>
<script src="<?php echo assets('exam/lib/lightbox/js/lightbox.min.js'); ?>"></script>

<!-- site.js -->
<!--<script src="--><?php //echo assets('exam/Exam css/js/site.js'); ?><!--"></script>-->

<!-- user info -->
<script src="<?php echo assets('exam/Exam css/js/userInfo.js'); ?>"></script>
<script src="<?php echo assets('news/js/bootstrap.min.js'); ?>"></script>
<!-- WOW JS -->
<script src="<?php echo assets('news/js/wow.min.js'); ?>"></script>
<!-- Custom JS -->
<script src="<?php echo assets('news/js/custom.js'); ?>"></script>
<!-- timer -->
<script src="<?php echo assets('exam/Exam css/js/timer.js'); ?>"></script>

<!-- Contact Javascript File -->
<script src="<?php echo assets('exam/mail/jqBootstrapValidation.min.js'); ?>"></script>
<script src="<?php echo assets('exam/mail/contact.js'); ?>"></script>

<script src="<?php echo assets('exam/js/main.js'); ?>"></script>
</body>
