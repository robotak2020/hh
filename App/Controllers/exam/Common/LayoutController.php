...
class LayoutController extends Controller
{
    ...
    */
    public function render(ViewInterface $view)
    {
        ...
        foreach ($sections AS $section) {
            $data[$section] = in_array($section, $this->disabledSections) ? '' : $this->load->controller('exam/Common/' . ucfirst($section))->index();
        }

        return $this->view->render('exam/common/layout', $data);
    }
    ...
    */
    public function disable($section)
    {
     ...
     /**
     * Set the title for the exam page
     *
     * @param string $title
     * @return void
     */
